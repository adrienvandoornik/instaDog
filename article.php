...
<div class="container mt-5" >
    ...
    <div class="media border p-3 bg-white">
      <img src="https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn3.iconfinder.com%2Fdata%2Ficons%2Fbusiness-round-flat-vol-1-1%2F36%2Fuser_account_profile_avatar_person_student_male-512.png&f=1" alt="John Doe" class="mr-3 mt-3 rounded-circle" style="width:60px;">
      <div class="media-body">
        <h4>John Doe <small><i>Posted on February 19, 2016</i></small></h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua swded tzh j8 8k89k9 l0l k nh n gbt rtve rvx rre.</p>      
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  <h3 class="text-center text-white mt-3 text-decoration">Autres Articles</h3>
