...
<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
    <a class="navbar-brand text-light" href="galeriePhoto.php">InstaDog</a>
    ...
    <div class="collapse navbar-collapse" id="demo-navbar">
      <ul class="navbar-nav mr-auto">
        ...
        <a href="profil_user.php"><button type="button" class="btn btn-danger ml-4 mr-4">Ajouter Chien</button></a>
      </ul>
